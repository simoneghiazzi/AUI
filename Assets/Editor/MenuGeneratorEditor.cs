...
{
    SerializedProperty configurationname;
    SerializedProperty themepropertyname;
    SerializedProperty allowOnlyCompleteThemes;
    SerializedProperty generateAtRuntime;

    List<string> confignames = new List<string>();

    List<string> Propertynames = new List<string>();

    SerializedProperty hastheme;
