...
[CustomEditor(typeof(TrackerPlayerPosition))]
public class PlayerTrackGUI : Editor
{

    SerializedProperty activeTrackAxis;
    SerializedProperty playerIdentifier;
    SerializedProperty trackingSchema;
    SerializedProperty activateHandCloseEvents;
    SerializedProperty activateGestureEvents;
    SerializedProperty interactiveArea;

    void OnEnable()
    {
        activateHandCloseEvents = serializedObject.FindProperty("activateHandCloseEvents");
    ...
    {
        EditorGUILayout.PropertyField(activateHandCloseEvents);
        EditorGUILayout.PropertyField(activateGestureEvents);
